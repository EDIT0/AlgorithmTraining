        ...
        try {
            ...
            Arrays.sort(arr, new Comparator<int[]>() {
                ...
                public int compare(int[] o1, int[] o2) {
                     ...
                     * */
                    if(o1[0] != o2[0]) { // 각 객체의 0번째 수 비교
//                        int a = o1[0] - o2[0];
//                        System.out.println("비교1. " + o1[0] + "/" + o2[0] + "/" + a);
                        return o1[0] - o2[0]; // 각 0번째 수가 같지 않으면 0번째로 수 비교
                    } else {
//                        int a = o1[1] - o2[1];
//                        System.out.println("비교2. " + o1[1] + "/" + o2[1] + "/" + a);
                        return o1[1] - o2[1]; // 각 0번째 수가 같으면 1번째 수로 비교
                    }
                }
            });
